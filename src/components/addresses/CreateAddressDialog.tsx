...
import type { CreateAddressPayload } from "../../types/addresses";

type Props = {
  open: boolean;
  loading: boolean;
  setOpen: (value: boolean) => void;
  onCreateAddress: (data: CreateAddressPayload) => void;
};
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full h-full items-end justify-center text-center sm:items-center sm:p-0">
          ...
          >
            ...
            <div className="p-4">
              <h1 className="font-bold text-2xl">Create address</h1>
            </div>
            <div className="p-4">
              <AddressForm loading={loading} onSubmit={onCreateAddress} />
            </div>
          </DialogPanel>
        </div>
      </div>
